-- حل مشكلة نوع البيانات في Supabase
-- إذا كان هناك خطأ في نوع البيانات، جرب هذه الحلول

-- الحل 1: حذف الجدول وإعادة إنشاؤه بالطريقة الصحيحة
DROP TABLE IF EXISTS site_settings CASCADE;

CREATE TABLE site_settings (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  key VARCHAR(100) UNIQUE NOT NULL,
  value TEXT, -- استخدم TEXT بدلاً من VARCHAR لتجنب مشاكل الترميز
...
-- إضافة الإعدادات بالطريقة الصحيحة (واحدة تلو الأخرى)
